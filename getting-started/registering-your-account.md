...
Replace `<username>` with your Minecraft username.

4. Wait for the bot to confirm your registration.

![Registration Success Message](/assets/docs/screenshots/registration_success.png)
...
🔔 Don't want notifications? **[Mute the server](https://support.discord.com/hc/en-us/articles/209791877-How-do-I-mute-and-disable-notifications-for-specific-channels) instead.**

Stay in the server to keep your account and tiers active.
:::